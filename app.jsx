            ...
            <form className="quote-form" onSubmit={submit}>
              ...
              <label ref={consentRef} className={`consent ${flashConsent ? 'flash' : ''}`} htmlFor="sms-consent">
                ...
                <span className="consent-text">
                  By checking this box, I agree to receive text messages from (Shubh express INC). Message frequency varies. Message &amp; data rates may apply. Phone numbers collected for SMS purposes will not be shared with third parties or affiliates for marketing purposes under any circumstances. Text HELP to + (209) 407-4107 for assistance. You can reply STOP to unsubscribe at any time. Please refer to our <a href="#privacy" style={{color:'var(--blue)'}}>privacy policy</a>.
                </span>
              </label>
              ...
              <div className="form-actions">
                <span className="legal">By submitting you agree to our <a href="#privacy" style={{color:'var(--blue)'}}>privacy policy</a>. We never share your data.</span>
